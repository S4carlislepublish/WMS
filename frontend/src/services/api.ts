...
const API_URL = import.meta.env.VITE_API_URL || 'http://10.1.8.103:5000/api';
...
export const projectService = {
  ...
  uploadChapters: (
    ...
    apiService.uploadChapters(
      projectId,
      file
    ),

  parseChapterZip: (file: File) =>
  ...
  createProjectWithChapters: (
    ...
    apiService.createProjectWithChapters(
      payload,
      zipFile
    ),
  ...
  updateProjectChapter: (
    ...
    apiService.updateProjectChapter(
      projectId,
      chapterId,
      data
    ),
  ...
  deleteProjectChapter: (
    ...
    apiService.deleteProjectChapter(
      projectId,
      chapterId
    ),
};
