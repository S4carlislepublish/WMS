            ...
            <div className="ann-card">
              ...
              <div className="ann-card-body">
                <p style={{ fontSize: 14, color: "#64748B", lineHeight: 1.7, margin: 0 }}>
                  This page shows all official announcements from HR and management. 
                  New messages appear here in real time. Check back regularly to stay informed 
                  about company updates, policy changes, and events.
                </p>
                <div style={{ marginTop: 20, padding: "14px 16px", background: "#F8FAFC", borderRadius: 10, border: "1px solid #E2E8F0" }}>
                  <p style={{ fontSize: 12, fontWeight: 700, color: "#64748B", textTransform: "uppercase", letterSpacing: "0.05em", margin: "0 0 8px 0" }}>Total Announcements</p>
                  <p style={{ fontSize: 32, fontWeight: 800, color: "#0F172A", margin: 0 }}>{announcements.length}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="ann-card" style={{ minWidth: 0 }}>
            ...
            <div className="ann-card-header">
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <span className="ann-count-badge">{filteredAnnouncements.length}</span>
              </div>
            </div>
            ...
            {filteredAnnouncements.length === 0 ? (
              <div className="ann-empty">
                <div className="ann-empty-icon"><span>📭</span></div>
