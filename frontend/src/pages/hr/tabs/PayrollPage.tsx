...
const exportPayrollExcel = (): void => {
  window.location.href =
    `${BASE_URL}/attendance/export-paysheet`;
};
  ...
  <div className="fixed inset-0 bg-black/60 flex justify-center items-center z-50 backdrop-blur-sm">
    <div className="bg-white w-[950px] rounded-2xl shadow-2xl max-h-[92vh] overflow-y-auto">
      ...
      <div className="flex justify-between items-center p-6 border-b border-gray-200">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Employee Payroll Details</h2>
          <p className="text-sm text-gray-500 mt-1">{selectedEmployee.employee_id} • {selectedEmployee.department}</p>
        </div>
        <button
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-3 gap-5">
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              ...
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.name}</div>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Employee ID</div>
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.employee_id}</div>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Email</div>
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.email}</div>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Phone</div>
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.phone}</div>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Department</div>
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.department}</div>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Designation</div>
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.designation}</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
            <svg className="w-5 h-5 mr-2 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.063 0-5.917-.857-8.377-2.345L2 21h20l-1.623-4.255A23.932 23.932 0 0112 15z" />
            </svg>
            Employment Details
          </h3>
          <div className="grid grid-cols-3 gap-5">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <div className="text-xs text-blue-500 uppercase tracking-wide">Salary</div>
              <div className="text-sm mt-1 font-bold text-blue-900">₹{selectedEmployee.salary}</div>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Shift Timing</div>
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.shift_timing}</div>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Joining Date</div>
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.joining_date}</div>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Reporting Manager</div>
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.reporting_manager}</div>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Present Days</div>
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.present_days}</div>
            </div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Leave Days</div>
              <div className="text-sm mt-1 font-medium text-gray-900">{selectedEmployee.leave_days}</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-center">
              <div className="text-xs uppercase tracking-wide opacity-75">Sick Leave</div>
              <div className="text-xl font-bold mt-1 text-red-900">{selectedEmployee.sick_leave}</div>
            </div>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-center">
              <div className="text-xs uppercase tracking-wide opacity-75">Casual Leave</div>
              <div className="text-xl font-bold mt-1 text-blue-900">{selectedEmployee.casual_leave}</div>
            </div>
            <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-center">
              <div className="text-xs uppercase tracking-wide opacity-75">Earned Leave</div>
              <div className="text-xl font-bold mt-1 text-green-900">{selectedEmployee.earned_leave}</div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          {selectedEmployee.leave_history?.length > 0 ? (
            <div className="border border-gray-200 rounded-lg overflow-hidden">
              <table className="w-full text-sm">
                <thead className="bg-indigo-50">
                  <tr>
                    <th className="px-4 py-3 text-left font-semibold text-indigo-900">Type</th>
                    <th className="px-4 py-3 text-left font-semibold text-indigo-900">From</th>
                    <th className="px-4 py-3 text-left font-semibold text-indigo-900">To</th>
                    <th className="px-4 py-3 text-left font-semibold text-indigo-900">Days</th>
                    <th className="px-4 py-3 text-left font-semibold text-indigo-900">Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  {selectedEmployee.leave_history.map((leave: any, index: number) => (
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-center">
              <span className="text-gray-500">No Leave History Found</span>
            </div>
          )}
        </div>
